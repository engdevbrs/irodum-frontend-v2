...
export default function Option2({ lebel, data, selected, handler,id }) {
  // content
            ...
            >
              <div className="filter-option">
                <div className="filter-option-inner">
                  <div id={id} className="filter-option-inner-inner">
                    {selected?.length !== 0 ? (
                      selected.join(",")
                    ) : (
                      <span style={{ color: "#999" }}>Nada Seleccionado</span>
                    )}
                  </div>
                </div>
              </div>
